...
class Sampler(nn.Module):
    ...
    def __init__(self, logprobs_mode: LogprobsMode = "raw_logprobs", vocab_size: int = 200000):
        super().__init__()
        ...
        # Start of EOL check
        #eol_lookup = torch.zeros(vocab_size, dtype=torch.bool, device='cuda')
        #eol_lookup[torch.tensor(EOL_TENSOR, dtype=torch.long, device='cuda')] = True
        #self.register_buffer('eol_lookup', eol_lookup)
    ...
    def forward(
        ...
        #sampled, processed_logprobs,match_mask = self.sample(logits, sampling_metadata)
        ...
        #return sampler_output,match_mask
    ...
    def sample(
        ...
        if sampling_metadata.all_random:
            ...
            if sampling_metadata.all_greedy:
                ...
                #match_mask = self.eol_lookup[greedy_sampled.long()]
                #return greedy_sampled, processed_logprobs, match_mask
        ...
        if greedy_sampled is None:
            #match_mask = self.eol_lookup[random_sampled.long()]
            #return random_sampled, processed_logprobs, match_mask
        ...
        #match_mask = self.eol_lookup[sampled.long()]
        #return sampled, processed_logprobs, match_mask
